        ...
        <main class="w-full max-w-5xl mx-auto">
            ...
            <div class="mb-12 border-b border-red-900/30 pb-6 text-center md:text-left">
                ...
                <p class="text-gray-400 text-sm leading-relaxed font-mono">
                    Get your message in front of a highly targeted, privacy-conscious audience. Launch powerful campaigns that appear directly on our search results and across all pastebins.
                </p>
            </div>
            ...
            <div class="mb-20">
                <div class="flex flex-col items-center mb-8">
                    ...
                    <p class="text-gray-500 font-mono text-xs text-center max-w-xl">Simple, transparent pricing for maximum exposure.</p>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="bg-[#0a0a0a] border border-white/5 p-8 rounded-sm hover:border-red-500/30 flex flex-col items-center text-center transition-colors">
                        ...
                        <p class="text-xs text-gray-400 font-mono leading-relaxed">Perfect for short-term campaigns and immediate visibility.</p>
                    </div>
                    <div class="bg-[#111111] border border-red-900/50 p-8 rounded-sm hover:border-red-500 flex flex-col items-center text-center transition-colors">
                        ...
                        <p class="text-xs text-gray-400 font-mono leading-relaxed">Our most popular plan. Maintain a strong presence all month.</p>
                    </div>
                    <div class="bg-[#0a0a0a] border border-white/5 p-8 rounded-sm hover:border-red-500/30 flex flex-col items-center text-center transition-colors">
                        ...
                        <p class="text-xs text-gray-400 font-mono leading-relaxed">Long-term domination. Secure your spot at the top.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-20">
                <div class="bg-[#0a0a0a] border border-white/5 p-8 rounded-sm hover:border-red-500/30 transition-colors">
                    <div class="w-12 h-12 bg-red-950/20 rounded flex items-center justify-center text-red-500 mb-6 border border-red-900/30">
                    ...
                    <p class="text-xs text-gray-400 font-mono leading-relaxed">Your ad will be injected seamlessly into the DoxMe search results, capturing users at their highest intent.</p>
                </div>
                <div class="bg-[#0a0a0a] border border-white/5 p-8 rounded-sm hover:border-red-500/30 transition-colors">
                    <div class="w-12 h-12 bg-red-950/20 rounded flex items-center justify-center text-red-500 mb-6 border border-red-900/30">
                    ...
                    <p class="text-xs text-gray-400 font-mono leading-relaxed">Display your banner or text ad on every active pastebin, guaranteeing thousands of daily impressions.</p>
                </div>
                <div class="bg-[#0a0a0a] border border-white/5 p-8 rounded-sm hover:border-red-500/30 transition-colors">
                    <div class="w-12 h-12 bg-red-950/20 rounded flex items-center justify-center text-red-500 mb-6 border border-red-900/30">
                    ...
                    <p class="text-xs text-gray-400 font-mono leading-relaxed">Gain access to a dedicated dashboard to manage campaigns, upload banners, and track real-time analytics.</p>
                </div>
            </div>
            ...
            <div class="mb-20">
                <div class="flex flex-col items-center mb-8">
                    <h2 class="text-2xl font-black text-white tracking-tighter uppercase mb-2">Exclusive Advertiser Suite</h2>
                    <p class="text-gray-500 font-mono text-xs text-center max-w-xl">Take full control of your campaigns with our custom-built, cyber-aesthetic Advertiser Dashboard.</p>
                </div>
                ...
                <div class="rounded-lg border border-white/10 bg-[#0a0a0a] overflow-hidden shadow-2xl">
                    ...
                    <div class="bg-[#111] border-b border-white/5 px-4 py-3 flex items-center gap-2">
                        ...
                        <div class="ml-4 text-[10px] font-mono text-gray-500 uppercase tracking-widest flex-1">Advertiser_Dashboard.exe</div>
                    ...
                    <div class="flex flex-col md:flex-row min-h-[440px]">
                        <!-- Sidebar -->
                        <div class="w-full md:w-48 border-r border-white/5 bg-[#050505] p-4 flex flex-col gap-2 flex-shrink-0">
                            <div class="px-3 py-2 bg-red-600/10 text-red-500 text-xs font-bold flex items-center gap-2 border border-red-900/30">
                        ...
                        <div class="flex-1 p-6 bg-[#080808]">
                            <div class="flex justify-between items-center mb-6 border-b border-white/5 pb-4">
                                <h3 class="text-white font-bold uppercase tracking-widest text-sm">Campaign Overview</h3>
                                <a href="#submit-ad-section" class="px-3 py-1 bg-red-600 text-white text-xs font-black uppercase hover:bg-red-700 transition-colors">
                                    New Campaign
                                </a>
                            </div>
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
                                <div class="bg-[#111] p-4 border border-white/5 rounded-sm">
                                    <div class="text-[9px] text-gray-500 uppercase tracking-widest font-mono mb-1">Active Ads</div>
                                    <div class="text-2xl text-white font-black">{{ $activeCount }}</div>
                                </div>
                                <div class="bg-[#111] p-4 border border-white/5 rounded-sm">
                                    <div class="text-[9px] text-gray-500 uppercase tracking-widest font-mono mb-1">Total Impressions</div>
                                ...
                                <div class="bg-[#111] p-4 border border-white/5 rounded-sm">
                                    <div class="text-[9px] text-gray-500 uppercase tracking-widest font-mono mb-1">Total Clicks</div>
                                ...
                                <div class="bg-[#111] p-4 border border-white/5 rounded-sm">
                                    <div class="text-[9px] text-gray-500 uppercase tracking-widest font-mono mb-1">Avg CTR</div>
                            ...
                            @if($totalImpressions > 0)
                                <div class="mb-5">
                                    ...
                                    <div class="w-full h-1 bg-white/5 rounded-full overflow-hidden">
                                        <div class="h-full bg-green-500 rounded-full" style="width: {{ $ctrBarWidth }}%"></div>
                                    </div>
                                </div>
                            @endif
                            ...
                            <div class="bg-[#111] border border-white/5 rounded-sm overflow-hidden">
                                <div class="flex justify-between items-center text-[10px] text-gray-400 font-mono border-b border-white/5 px-4 py-2.5">
                                ...
                                <div class="divide-y divide-white/5 max-h-52 overflow-y-auto">
                                    @forelse($activeBanners as $banner)
                                        <a href="{{ route('ads.click', $banner->id) }}"
                                           target="_blank"
                                           rel="noopener noreferrer"
                                           class="flex items-center gap-3 px-4 py-2.5 hover:bg-white/5 transition-colors group">
                                            <div class="w-16 h-8 flex-shrink-0 overflow-hidden rounded-sm border border-white/5 bg-[#050505]">
                                                <img src="{{ asset($banner->media_url) }}"
                                                     alt="{{ $banner->title }}"
                                                     class="w-full h-full object-cover opacity-80 group-hover:opacity-100 transition-opacity">
                                            </div>
                                            <div class="flex-1 min-w-0">
                                                <div class="text-[10px] font-bold text-gray-200 truncate group-hover:text-red-400 transition-colors">
                                                    {{ $banner->title }}
                                                </div>
                                            ...
                                            <span class="text-[8px] font-black px-1.5 py-0.5 border border-green-800/50 bg-green-950/20 text-green-500 uppercase flex-shrink-0">
                                                LIVE
                                            </span>
                                        </a>
                                    @empty
            ...
            @if($activeBanners->isNotEmpty())
                <div class="mb-20">
                    <div class="flex flex-col items-center mb-8">
                        <h2 class="text-2xl font-black text-white tracking-tighter uppercase mb-2">Current Live Banners</h2>
                        <p class="text-gray-500 font-mono text-xs text-center max-w-xl">
                            These banners are currently running across the entire platform.
                        </p>
                    </div>

                    <div class="flex flex-col gap-4">
                        @foreach($activeBanners as $banner)
                            <div class="group border border-red-900/20 rounded-sm overflow-hidden bg-[#0a0a0a] hover:border-red-500/40 transition-colors">
                                <a href="{{ route('ads.click', $banner->id) }}"
                                   target="_blank"
                                   rel="noopener noreferrer"
                                   class="block">
                                    <img src="{{ asset($banner->media_url) }}"
                                         alt="{{ $banner->title }}"
                                         class="w-full object-cover opacity-85 group-hover:opacity-100 transition-opacity"
                                         style="max-height: 90px;">
                                </a>
                                <div class="px-5 py-3 flex items-center justify-between gap-4">
                                    <div class="min-w-0 flex-1">
                                        <div class="text-xs font-black text-white truncate">{{ $banner->title }}</div>
                                        <div class="text-[9px] font-mono text-gray-500 mt-0.5">
                                            {{ number_format($banner->total_clicks) }} clicks
                                            &middot;
                                            {{ number_format($banner->total_impressions) }} impressions
                                            @if($banner->total_impressions > 0)
                                                &middot;
                                                CTR: {{ round(($banner->total_clicks / $banner->total_impressions) * 100, 2) }}%
                                            @endif
                                        </div>
                                    </div>
                                    <div class="flex items-center gap-1.5 flex-shrink-0">
                                        <span class="w-1.5 h-1.5 rounded-full bg-green-500"></span>
                                        <span class="text-[8px] font-black text-green-500 uppercase tracking-widest">LIVE</span>
                                    </div>
                                </div>
                            </div>
                        @endforeach
            ...
            <div id="submit-ad-section" class="border-t border-white/5 pt-16">
                <div class="flex flex-col items-center mb-10">
                    <h2 class="text-2xl font-black text-white tracking-tighter uppercase mb-2">Submit Your Ad Request</h2>
                    <p class="text-gray-500 font-mono text-xs text-center max-w-xl">Fill out the form below. Once approved, your ad campaign will be scheduled for launch.</p>
                </div>

                @if(session('success'))
                    <div class="mb-6 p-4 bg-green-950/20 border border-green-900/50 rounded-sm max-w-3xl mx-auto flex items-start gap-3">
                ...
                <div class="bg-[#0a0a0a] border border-white/5 rounded-sm p-8 max-w-3xl mx-auto">
                    <form action="{{ route('advertise.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <div class="border-2 border-dashed border-white/10 rounded-sm p-8 text-center bg-[#111] hover:border-red-500/50 cursor-pointer"
                                ...
                                <input type="file" id="image" name="image" accept="image/*" class="hidden" required onchange="previewAdImage(event)">
                                <div id="upload-ad-placeholder" class="flex flex-col items-center">
                                    <svg class="w-8 h-8 text-gray-600 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12"/></svg>
                                    <span class="text-xs font-bold text-gray-400 font-mono">Click to upload banner (Max 5MB)</span>
                                </div>
                                <div id="ad-image-preview-container" class="hidden w-full relative">
                                    <img id="ad-image-preview" src="#" alt="Preview" class="max-h-32 mx-auto rounded-sm border border-white/10">
                                    <button type="button"
